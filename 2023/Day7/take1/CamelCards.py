...
for i in range(len(rankings)-1,-1,-1):
    ...
    print(count , len(ranks[rankings[i]]) , "hahahaah")
    print("-----------------------------------------------------------------------------------------")
    for bid in range (len(ranks[rankings[i]])):
        print(total ,"before")
        total += bids[ranks[rankings[i]][bid]] * count
        #print(values[ranks[rankings[i]][bid]] ,ranks[rankings[i]][bid] , count)
        #print(bids[ranks[rankings[i]][bid]], ranks[rankings[i]][bid], count)
        print(bids[ranks[rankings[i]][bid]], ranks[rankings[i]][bid], values[ranks[rankings[i]][bid]], count)
        print(total ,"after")
        print("*********")
        count+=1
    print(total ,"is now" )
print(numberof, total)
# with open("output.txt", "a") as file:
#     for i in range(len(rankings)-1,-1,-1):
#         print(rankings[i], file=file)
#         print(ranks[rankings[i]],file=file)
#         print(count , len(ranks[rankings[i]]) , "hahahaah", file=file)
#         print("-----------------------------------------------------------------------------------------")
#         for bid in range (len(ranks[rankings[i]])):
#             print(total ,"before",file=file)
#             total += bids[ranks[rankings[i]][bid]] * count
#             #print(values[ranks[rankings[i]][bid]] ,ranks[rankings[i]][bid] , count)
#             print(bids[ranks[rankings[i]][bid]], ranks[rankings[i]][bid], values[ranks[rankings[i]][bid]], count,file=file)
#             print(total ,"after",file=file)
#             print("*********",file=file)
#             count+=1
#         print(total ,"is now",file=file )
# print(numberof, total)
#20591885
#248510480
#248491551